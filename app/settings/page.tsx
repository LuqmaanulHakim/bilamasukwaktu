      ...
      >
        <div className="flex items-center gap-2 mb-1">
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold" style={{ color: "var(--foreground)" }}>Zon Kawasan</p>
            <p className="text-xs" style={{ color: "var(--muted)" }}>Pilih zon anda</p>
          </div>
        </div>
        ...
        >
          ...
          <span>{isLocating ? "Mencari" : isSuccess ? "Jumpa" : isError ? "Gagal" : "GPS"}</span>
          {isLocating && (
            <span
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            style={{ background: showCountdown ? "var(--accent)" : "var(--card-border)" }}
          >
            <span
      ...
      >
        <div className="flex items-center gap-2">
          <div
            ...
            style={{ background: isDark ? "#1e3a5f" : "#eef2ff" }}
          >
            {isDark ? <Moon size={16} className="text-indigo-400" /> : <Sun size={16} className="text-indigo-500" />}
          </div>
          <div>
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-medium" style={{ color: "var(--foreground)" }}>Mod Gelap</p>
            <p className="text-xs mt-0.5" style={{ color: "var(--muted)" }}>{isDark ? "Buka" : "Tutup"}</p>
          </div>
          <button
            onClick={toggleTheme}
            ...
            {ACCENT_COLORS.map((color) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: isActive ? swatch + (isDark ? "33" : "18") : "transparent",
                    border: "1.5px solid",
